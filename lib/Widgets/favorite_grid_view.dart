...
class _FavoriteGridViewState extends State<FavoriteGridView> implements HomeContract{
...
class _FavListState extends State<FavList> {
  ...
  Widget build(BuildContext context) {
    ...
    return widget.favorites.length == 0? Center(child: Column(
      mainAxisAlignment: MainAxisAlignment.center,
      children: <Widget>[
              ...
              title: Parent(
                  ...
                  gesture: Gestures()
                    ..isTap((isPressed) => Navigator.pushNamed(
                          context,
                          '/audio-detail',
                          arguments: widget.favorites[i].id,
                        ))),
            ),
