...
class TestScreen extends StatefulWidget {
  TestScreen({Key key, this.id, this.title, this.imgUrl, this.catId,this.body})
      : super(key: key);
...
class _TestScreenState extends State<TestScreen> implements HomeContract {
      ...
      body: SafeArea(
        ...
        Expanded(
            ...
            child: SingleChildScrollView(
                      ...
                      builder: (BuildContext context, AsyncSnapshot snapshot) {
                        ...
                        return isItRecord == false
                            ...
                            : InkWell(
                                onTap: () {
                                  setState(() {
                                    homePresenter.delete(int.parse(widget.id));
                                    isItRecord = false;
              ...
              Container(width: double.infinity, child: Text(widget.body,style: TextStyle(color: Colors.black87),textAlign: TextAlign.justify,))
                ],
              ),
            ),
          ),
